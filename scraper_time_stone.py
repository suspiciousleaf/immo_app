...
def time_stone_get_listings(host_photos=False):
    ...
    results_pages = [f"https://www.timeandstoneimmobilier.com/fr/liste.htm?tri=DTE_CREA&menuSave=1&tdp=1&page={i}&TypeModeListeForm=text&lieu-alentour=0#page={i}&tdp=1&menuSave=1&tri=DTE_CREA&TypeModeListeForm=text" for i in range(1, pages + 1)]
    links = []
...
# Time elapsed for Time & Stone: 41.73486948013306 full scrape